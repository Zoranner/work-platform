      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">组织编号</th>
              <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">组织名称</th>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="org in orgList" :key="org.id">
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ org.orgNumber }}</td>
